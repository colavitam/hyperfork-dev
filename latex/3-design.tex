...
In this section we describe our HyperFork architecture and implementation,
including the overall platform architecture, the relevant implemetation details
of KVM and kvmtool, as well as our design decisions regarding the flash-cloning
operation.
...
Once the pre-fork routine is complete, kvmtool calls Linux fork(). In the
